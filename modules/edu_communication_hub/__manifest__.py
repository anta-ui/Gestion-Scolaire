...
Compatible avec OpenEduCat et Odoo 17.0
    ...
    'depends': [
        ...
        'portal',
        'website',
        # Dépendances OpenEduCat commentées car non installables
    ...
    'data': [
        ...
        'views/edu_campaign_views.xml',
        'views/edu_announcement_views.xml',
        'views/edu_notification_views.xml',
        'views/edu_communication_provider_views.xml',
        'views/edu_chat_views.xml',
        'views/edu_communication_analytics_views.xml',
    ],
