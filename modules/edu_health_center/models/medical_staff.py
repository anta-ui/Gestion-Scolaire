...
class MedicalStaff(models.Model):
    ...
    staff_type = fields.Selection([
        ...
        ('other', 'Autre')
    ], string='Type de personnel', required=True, tracking=True)
    
    specialization = fields.Char(
        string='Spécialisation',
        help="Spécialisation médicale"
    )
    ...
    employee_id = fields.Many2one(
        'hr.employee',
        string='Employé lié',
        help="Employé Odoo lié"
    )
    
    user_id = fields.Many2one(
        'res.users',
        string='Utilisateur',
        help="Utilisateur Odoo lié"
    )
